...
// Single source of truth for build flags, shared with scripts/generate_assets_data.ts
...
export default defineConfig((options) => ({
	...
	sourcemap: true,
	// Replaces webpack DefinePlugin; values come from scripts/env.js (edit that file to change them)
	define: {
		DEBUG: String(!isDist),
